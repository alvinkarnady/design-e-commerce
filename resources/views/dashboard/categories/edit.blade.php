...
@section('container')
    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/categories/{{ $category->slug_categories }}" class="mb-5"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('name_categories') is-invalid @enderror "
                    id="name_categories" name="name_categories" autofocus
                    value="{{ old('name_categories', $category->name_categories) }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('slug_categories') is-invalid @enderror"
                    id="slug_categories" name="slug_categories"
                    value="{{ old('slug_categories', $category->slug_categories) }}" required>
            ...
            <div class="mb-3">
                ...
                <input type="hidden" name="oldImage" value="{{ $category->image_categories }}">

                @if ($category->image_categories)
                    <img src="{{ asset('storage/' . $category->image_categories) }}"
